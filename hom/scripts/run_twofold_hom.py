...
def run_twofold_hom(temperature, power):
...
if __name__ == "__main__":
    ...
    if temperature is None or temperature[-1] != "C":
        throw_parameter_error()
    # expect power in mW like "10mW"
    if power is None or power[-2:] != "mW":
        throw_parameter_error()
    ...
    run_twofold_hom(temperature, power)